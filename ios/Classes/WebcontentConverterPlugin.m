...
#if __has_include(<webcontent_converter_esc_printer/webcontent_converter_esc_printer-Swift.h>)
#import <webcontent_converter_esc_printer/webcontent_converter_esc_printer-Swift.h>
#else
